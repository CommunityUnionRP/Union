...
exports = (menu) => {
    ...
    mp.events.add("render", () => {
        ...
        if (mp.clientStorage.insideWarehouseProducts) drawText2d("~y~ Используйте ~w~E ~y~ для погрузки товара", [0.5, 0.1]);
        else if (mp.clientStorage.insideProducts) drawText2d("~y~ Используйте ~w~E ~y~ для взятия товара", [0.5, 0.1]);
