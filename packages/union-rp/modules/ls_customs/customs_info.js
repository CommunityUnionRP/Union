const customsInfo = {
	places: [
		...
		{ // 1
			waypointRecord: "carmod_05_intro",
			door: { model: 270330101, position: new mp.Vector3(723.116, -1088.831, 23.23201) },
			angledArea: {
				origin: new mp.Vector3(719.7279, -1083.273, 20.44044),
				edge: new mp.Vector3(719.9546, -1093.446, 25.32475),
				angle: 9.5,
				headingBound: [ 275.1679, 90 ]
			},
			enterPosition: new mp.Vector3(724.524, -1089.081, 21.1692),
			startVehInfo: {
				position: new mp.Vector3(723.4568, -1089.124, 21.2235),
				heading: 271.0299
			},
			exitVehInfo: [
				{ position: new mp.Vector3(717.7614, -1088.7040, 21.9231), heading: 89.8590 },
				{ position: new mp.Vector3(716.4597, -1073.5409, 21.8428), heading: 0.0327 },
				{ position: new mp.Vector3(716.6584, -1057.3738, 21.6015), heading: 359.5137 },
				{ position: new mp.Vector3(710.2021, -1079.4532, 21.9521), heading: 0.9659 },
				{ position: new mp.Vector3(709.6703, -1065.3257, 21.8996), heading: 0.8612 }
			],
			startCamParams: {
				from: {
					position: new mp.Vector3(727.9932, -1074.518, 21.94219),
					rotation: new mp.Vector3(2.894465, -0.056487, -172.8471),
					fov: 42.5,
					duration: 0,
					unk: 1
				},
				to: {
					position: new mp.Vector3(731.1161, -1073.823, 21.92089),
					rotation: new mp.Vector3(4.065939, -0.056487, -172.1623),
					fov: 42.5,
					duration: 6250,
					unk: 3
				}
			},
			lampObj: { model: 0x51CA161F, position: new mp.Vector3(731.491, -1086.889, 22.629), rotation: new mp.Vector3(0, 0, 196.56) }
		},
		{ // 2
		...
		{ // 3
			...
			door: { model: -822900180, position: new mp.Vector3(114.3135, 6623.233, 32.67305) },
			closedDoors: [
				{ model: -822900180, position: new mp.Vector3(108.8502, 6617.877, 32.67305) },
				{ model: 1335311341, position: new mp.Vector3(105.1518, 6614.655, 32.58521) }
			],
			angledArea: {
				origin: new mp.Vector3(108.7427, 6612.336, 31.00019),
				edge: new mp.Vector3(119.6283, 6623.331, 34.959),
				angle: 10.4375,
				headingBound: [ 46.3721, 360 ]
			},
			enterPosition: new mp.Vector3(113.2615, 6624.28, 30.7871),
			startVehInfo: {
				position: new mp.Vector3(111.37, 6625.36, 31.31),
				heading: 44.69071
			},
			exitVehInfo: [
				{ position: new mp.Vector3(119.3104, 6618.1152, 31.4138), heading: 225.3006 },
				{ position: new mp.Vector3(140.8553, 6607.9121, 31.4247), heading: 178.8372 },
				{ position: new mp.Vector3(145.7735, 6603.1191, 31.4366), heading: 180.2485 },
				{ position: new mp.Vector3(150.7746, 6599.0269, 31.4302), heading: 175.8104 },
				{ position: new mp.Vector3(117.4365, 6599.5688, 31.5953), heading: 271.2165 }
			],
			lampObj: { model: 0xB64A63A5, position: new mp.Vector3(110.594, 6628.001, 32.26), rotation: new mp.Vector3(0, 0, 41.76) }
		},
		{ // 4
			waypointRecord: false,
			door: { model: 0xCEF38A2C, position: new mp.Vector3(1174.654, 2645.242, 38.6826) },
			closedDoors: [
	...
	prices: {
		repair: 1,
		mods: {
			0: { base: 0.01, add: 0.03 }, // Спойлеры
			1: { base: 0.01, add: 0.03 }, // Передние бамперы
			2: { base: 0.01, add: 0.03 }, // Задние бамперы
			3: { base: 0.01, add: 0.03 }, // Юбки
			4: { base: 0.02, add: 0.03 }, // Глушители
			5: { base: 0.01, add: 0.03 }, // Каркас безопасности
			6: { base: 0.03, add: 0.03 }, // Решетки радиатора
			7: { base: 0.03, add: 0.03 }, // Капот
			10: { base: 0.02, add: 0.03 }, // Крыша
