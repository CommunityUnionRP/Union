        ...
        if (entity.type == "vehicle") {
            ...
            entity.utils = {
                ...
                setEngineBroken: (enable) => {
                    ...
                    if (enable) {
                        if (entity.player) {
                            entity.player.utils.warning(`Двигатель поломан!`);
                ...
                setOilBroken: (enable) => {
                    ...
                    if (enable) {
                        if (entity.player) {
                            entity.player.utils.warning(`Моторное масло потеряло свои свойства!`);
                            entity.player.call("prompt.showByName", ["vehicle_repair"]);
                        }
                        if (entity.getVariable("engine")) entity.utils.engineOn();
                    }
                ...
                setAccumulatorBroken: (enable) => {
                    ...
                    if (enable) {
                        if (entity.player) {
                            entity.player.utils.warning(`Аккумулятор поломан!`);
                            entity.player.call("prompt.showByName", ["vehicle_repair"]);
                        }
                        if (entity.getVariable("engine")) entity.utils.engineOn();
                    }
                ...
                setFuel: (fuel) => {
                    ...
                    if (fuel <= 0) {
                        if (entity.player) {
                            entity.player.utils.warning(`Заправьте автомобиль!`);
                        }
                        entity.setVariable("engine", false);
                    }
                },
